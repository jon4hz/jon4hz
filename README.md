...
- [adfinis/helm-charts](https://github.com/adfinis/helm-charts) ([openshift-etcd-backup-1.8.12](https://github.com/adfinis/helm-charts/releases/tag/openshift-etcd-backup-1.8.12), today) - 📈 Helm charts from Adfinis
...
- [fix: suggest debian-security repo from adfinis mirror](https://github.com/adfinis/landingpage-repo_mirror/pull/121) on [adfinis/landingpage-repo_mirror](https://github.com/adfinis/landingpage-repo_mirror) (1 day ago)
...
- [juxtopposed/touchgrass](https://github.com/juxtopposed/touchgrass) - touch grass online. no need to go outside. (1 day ago)
- [atuinsh/atuin](https://github.com/atuinsh/atuin) - ✨ Magical shell history (1 day ago)
- [kkapsner/NewTabUrl](https://github.com/kkapsner/NewTabUrl) - Web-Extension to controll the page for new tabs (3 days ago)
...
- [rgl/proxmox-ve](https://github.com/rgl/proxmox-ve) - Proxmox VE Vagrant Base Box (4 days ago)
