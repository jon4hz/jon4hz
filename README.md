...
- [adfinis/ansible-role-icinga2_master](https://github.com/adfinis/ansible-role-icinga2_master) ([v1.4.2](https://github.com/adfinis/ansible-role-icinga2_master/releases/tag/v1.4.2), 2 days ago) - This role is used to configure an icinga2 master
...
- [go-jose/go-jose](https://github.com/go-jose/go-jose) - An implementation of JOSE standards (JWE, JWS, JWT) in Go (1 day ago)
