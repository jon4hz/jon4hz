...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([39.15.2](https://github.com/renovatebot/renovate/releases/tag/39.15.2), today) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ([netbox-5.0.0-beta.142](https://github.com/netbox-community/netbox-chart/releases/tag/netbox-5.0.0-beta.142), 1 day ago) - A Helm chart for NetBox
...
- [adfinis/helm-charts](https://github.com/adfinis/helm-charts) ([cert-manager-issuers-0.3.0](https://github.com/adfinis/helm-charts/releases/tag/cert-manager-issuers-0.3.0), 3 days ago) - 📈 Helm charts from Adfinis
...
- [wfg/docker-wireguard](https://github.com/wfg/docker-wireguard) - A lightweight, containerized WireGuard (6 days ago)
- [f-eld-ch/sitrep](https://github.com/f-eld-ch/sitrep) - SitRep: Digitale Lagebewirtschaftung für Führungsstäbe (6 days ago)
