...
- [zskarte/zskarte](https://github.com/zskarte/zskarte) ([v5.0.1](https://github.com/zskarte/zskarte/releases/tag/v5.0.1), 1 day ago) - Zivilschutz-Karte allows to draw situation maps for disaster management
- [christianhuth/helm-charts](https://github.com/christianhuth/helm-charts) ([umami-4.3.0](https://github.com/christianhuth/helm-charts/releases/tag/umami-4.3.0), 2 days ago) - Helm Charts for various Applications
...
- [rospogrigio/localtuya](https://github.com/rospogrigio/localtuya) - local handling for Tuya devices (6 days ago)
- [savdagod/ha-addons](https://github.com/savdagod/ha-addons) - HA add-on repository (6 days ago)
- [savdagod/TidbytAssistant](https://github.com/savdagod/TidbytAssistant) - Send custom apps, notifications or plain text to a Tidbyt device from HomeAssistant! (6 days ago)
- [tronbyt/server](https://github.com/tronbyt/server) - Manage your apps on your Tronbyt (flashed Tidbyt) completely locally without relying on the backend servers operated by Tidbyt. (6 days ago)
