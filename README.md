...
- [semaphoreui/semaphore](https://github.com/semaphoreui/semaphore) ([v2.19.6-rc1](https://github.com/semaphoreui/semaphore/releases/tag/v2.19.6-rc1), today) - Modern UI and powerful API for Ansible, Terraform/OpenTofu/Terragrunt, PowerShell and other DevOps tools.
...
- [fix: switch from community.mysql to ansible.mysql](https://github.com/adfinis/ansible-collection-icinga2/pull/6) on [adfinis/ansible-collection-icinga2](https://github.com/adfinis/ansible-collection-icinga2) (today)
