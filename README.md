...
- [adfinis/proxmox-tofu-demo](https://github.com/adfinis/proxmox-tofu-demo) -  (2 days ago)
- [openbao/openbao](https://github.com/openbao/openbao) - OpenBao is a software solution to manage, store, and distribute sensitive data including secrets, certificates, and keys. (3 days ago)
- [adfinis/ansible-collection-semaphoreui](https://github.com/adfinis/ansible-collection-semaphoreui) -  (1 week ago)
...
- [jon4hz/gnome-shell-extension-aareguru](https://github.com/jon4hz/gnome-shell-extension-aareguru) ([v1.3.1](https://github.com/jon4hz/gnome-shell-extension-aareguru/releases/tag/v1.3.1), 2 days ago) - Aare.guru ir gnome shell
...
- [CyferShepard/Jellystat](https://github.com/CyferShepard/Jellystat) ([1.1.9](https://github.com/CyferShepard/Jellystat/releases/tag/1.1.9), 2 weeks ago) - Jellystat is a free and open source Statistics App for Jellyfin
...
- [ci: pin actions and improve workflow security](https://github.com/adfinis/proxmox-tofu-demo/pull/4) on [adfinis/proxmox-tofu-demo](https://github.com/adfinis/proxmox-tofu-demo) (3 days ago)
- [agent: allow changing the uid and gid of a file sink](https://github.com/openbao/openbao/pull/2851) on [openbao/openbao](https://github.com/openbao/openbao) (6 days ago)
...
- [eduardofuncao/squix](https://github.com/eduardofuncao/squix) - A minimal CLI tool for managing and executing SQL queries across multiple databases. Written in Go, made beautiful with BubbleTea (2 days ago)
- [gabrie30/ghorg](https://github.com/gabrie30/ghorg) - Quickly clone or backup an entire org/users repositories into one directory - Supports GitHub, GitLab, Bitbucket, and more 🐇🥚 (2 days ago)
