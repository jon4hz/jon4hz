...
- [adfinis/helm-charts](https://github.com/adfinis/helm-charts) ([keycloak-operator-1.12.0](https://github.com/adfinis/helm-charts/releases/tag/keycloak-operator-1.12.0), 1 day ago) - 📈 Helm charts from Adfinis
...
- [feat: support different upgrade modes and custom files](https://github.com/adfinis/ansible-role-the_bastion/pull/34) on [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) (1 day ago)
- [ci: one publish pipeline only without PAT](https://github.com/adfinis/ansible-role-the_bastion/pull/33) on [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) (1 day ago)
