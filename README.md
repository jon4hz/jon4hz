...
- [projectpotos/actions](https://github.com/projectpotos/actions) ([v0.4.0](https://github.com/projectpotos/actions/releases/tag/v0.4.0), 2 days ago) - Reusable GitHub Actions workflows and composite actions for all potos projects.
- [openbao/openbao](https://github.com/openbao/openbao) ([v2.6.0](https://github.com/openbao/openbao/releases/tag/v2.6.0), 2 days ago) - OpenBao is a software solution to manage, store, and distribute sensitive data including secrets, certificates, and keys.
- [semaphoreui/semaphore](https://github.com/semaphoreui/semaphore) ([v2.19.5-beta6](https://github.com/semaphoreui/semaphore/releases/tag/v2.19.5-beta6), 2 days ago) - Modern UI and powerful API for Ansible, Terraform/OpenTofu/Terragrunt, PowerShell and other DevOps tools.
- [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) ([v0.10.0](https://github.com/adfinis/ansible-role-the_bastion/releases/tag/v0.10.0), 3 days ago) - Ansible role to install and configure The Bastion
