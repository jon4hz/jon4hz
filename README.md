...
- [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) ([v0.7.0](https://github.com/adfinis/ansible-role-the_bastion/releases/tag/v0.7.0), 5 days ago) - Ansible role to install and configure The Bastion
...
- [ci(molecule): verify correct version](https://github.com/adfinis/ansible-role-the_bastion/pull/22) on [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) (5 days ago)
- [chore: upgrade default bastion version to v3.23.01](https://github.com/adfinis/ansible-role-the_bastion/pull/21) on [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) (5 days ago)
- [ci: create molecule pipeline and use docker driver](https://github.com/adfinis/ansible-role-the_bastion/pull/20) on [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) (5 days ago)
- [feat: support arbitrary plugin configurations](https://github.com/adfinis/ansible-role-the_bastion/pull/19) on [adfinis/ansible-role-the_bastion](https://github.com/adfinis/ansible-role-the_bastion) (5 days ago)
...
- [systemd/particleos](https://github.com/systemd/particleos) - ⸭ An image-based, secure OS, built on top of various Linux distributions (4 days ago)
