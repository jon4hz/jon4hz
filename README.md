...
- [jon4hz/gnome-shell-extension-aareguru](https://github.com/jon4hz/gnome-shell-extension-aareguru) - Aare.guru ir gnome shell (4 weeks ago)
- [adfinis/proxmox-tofu-demo](https://github.com/adfinis/proxmox-tofu-demo) -  (4 weeks ago)
...
- [adfinis/helm-charts](https://github.com/adfinis/helm-charts) ([infra-apps-0.268.0](https://github.com/adfinis/helm-charts/releases/tag/infra-apps-0.268.0), 1 week ago) - 📈 Helm charts from Adfinis
...
- [eduardofuncao/squix](https://github.com/eduardofuncao/squix) - A minimal CLI tool for managing and executing SQL queries across multiple databases. Written in Go, made beautiful with BubbleTea (4 weeks ago)
- [gabrie30/ghorg](https://github.com/gabrie30/ghorg) - Quickly clone or backup massive amounts of org/users repositories into one directory - Supports GitHub, GitLab, Bitbucket, and more 🐇🥚 (4 weeks ago)
