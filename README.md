...
- [semaphoreui/semaphore](https://github.com/semaphoreui/semaphore) ([v2.18.27](https://github.com/semaphoreui/semaphore/releases/tag/v2.18.27), today) - Modern UI and powerful API for Ansible, Terraform/OpenTofu/Terragrunt, PowerShell and other DevOps tools.
...
- [Banh-Canh/songbird](https://github.com/Banh-Canh/songbird) - Evaluate network policies configuration to check for connectivity  (5 days ago)
