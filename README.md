...
- [adfinis/ansible-collection-bareos](https://github.com/adfinis/ansible-collection-bareos) ([v2.2.6](https://github.com/adfinis/ansible-collection-bareos/releases/tag/v2.2.6), today) - A collection of Ansible roles to manage Bareos installations.
- [adfinis/helm-charts](https://github.com/adfinis/helm-charts) ([keycloak-operator-1.11.0](https://github.com/adfinis/helm-charts/releases/tag/keycloak-operator-1.11.0), today) - 📈 Helm charts from Adfinis
